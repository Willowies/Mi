...
<html>
	<head>
		<link rel="stylesheet" href="../css/miPad4.css" type="text/css"/>
	...
	<div class="mi8-index">
			<div class="section section-index" style="height: 696px;">
				<div class="txt" style="z-index: 10; margin-top:50px;">
					<h2 class="webfont">小米平板4</h2>
					<p class="webfont">单手可握的 8屏幕   |  骁龙660 高端处理器  |  海量影视内容的追剧神器  |  </p>
					<div class="price">
						<span>
							<sup>¥</sup>
							<i>1099</i>
						...
						<div class="ui-viewport" style="width: 100%;position: relative;height: 697px;">
							<ul class="list clearfix" style="width: auto;position: relative; height:696px">
								<li class="slider clearfix" style="float: none;list-style: outside none none;width: 1263px;z-index: 50;display: block;opacity: 0.960116;height:696px">
									<img src="../images/pad4.1.png" style="height:696px"/>
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="section section-infrared" id="box" style="height: 696px; margin-top:50px;">
				<h2 class="webfont" id="paragraph1" style="display: none;">单手可握的 8"屏</h2>
				<p id="paragraph2" style="display: none;">更小机身，更大屏占比</p>
			</div>
		</div>
