...
<html>
	<head>
		<link rel="stylesheet" href="../css/mi6X.css" type="text/css"/>
	...
	<div class="product-head-info">
			<div class="product-head-box">
				...
				<div class="con">
					<a href="displayProductSummary.action?productName=小米6X 极简保护壳">概述</a>&nbsp; |&nbsp;
					<a href="displayProductParameter.action?productName=小米6X 极简保护壳">参数</a>&nbsp; |&nbsp;
					<a href="getCommentPage.action?productName=小米6X 极简保护壳">用户评价</a>&nbsp; |&nbsp;
					<a href="selectProductInfo.action?productName=小米6X 极简保护壳" class="btn-toBuy">立即购买</a>
				</div>
			</div>
		</div>
	...
	<div class="mi8-index">
						...
						<div class="ui-viewport" style="width: 100%;position: relative;height: 697px;">
							<ul class="list clearfix" style="width: auto;position: relative; height:696px">
								<li class="slider clearfix" style="float: none;list-style: outside none none;width: 1263px;z-index: 50;display: block;opacity: 0.960116;height:696px">
									<img src="../images/mi6X_1.png" style="height:696px"/>
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="section section-infrared" id="box" style="height: 696px;">
				<h2 class="webfont" id="paragraph1" style="display: none;">小米6X · 精致细节</h2>
				<p id="paragraph2" style="display: none;">时尚实拍   美由心生</p>
			</div>
		</div>
