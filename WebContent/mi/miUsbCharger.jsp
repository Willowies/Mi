...
<html>
	<head>
		<link rel="stylesheet" href="../css/miUsbCharger.css" type="text/css"/>
	...
	<div class="product-head-info">
			<div class="product-head-box">
				...
				<div class="con">
					<a href="displayProductSummary.action?productName=小米USB充电器快充版（18W）">概述</a>&nbsp; |&nbsp;
					<a href="displayProductParameter.action?productName=小米USB充电器快充版（18W）">参数</a>&nbsp; |&nbsp;
					<a href="getCommentPage.action?productName=小米USB充电器快充版（18W）">用户评价</a>&nbsp; |&nbsp;
					<a href="selectProductInfo.action?productName=小米USB充电器快充版（18W）" class="btn-toBuy">立即购买</a>
				</div>
			</div>
		</div>
	...
	<div class="mi8-index">
			<div class="section section-index" style="height: 696px;">
				<div class="txt" style="z-index: 10px; margin-top:40px;">
					<h2 class="webfont">小米 USB充电器（4口）</h2>
					<p class="webfont">4个 USB 接口  |  2A 快充  |   总功率 35W |  多重安保|  轻巧便携</p>
					<div class="price">
						<span>
							<sup>¥</sup>
							<i>59</i>
						...
						<div class="ui-viewport" style="width: 100%;position: relative;height: 697px;">
							<ul class="list clearfix" style="width: auto;position: relative; height:696px">
								<li class="slider clearfix" style="float: none;list-style: outside none none;width: 1263px;z-index: 50;display: block;opacity: 0.960116;height:696px">
									<img src="../images/usbCharger1.png" style="height:696px"/>
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="section section-infrared" id="box" style="height: 696px;">
				<h2 class="webfont" id="paragraph1" style="display: none;">简约设计，简单使用</h2>
				<p id="paragraph2" style="display: none;">拒绝了生硬的方正外形，光滑圆润的倒角让一个简单的 USB 充电器也变的富有灵性，精巧却不失品质。超声波外壳组装</p>
			</div>
		</div>
