...
<html>
	<head>
		<link rel="stylesheet" href="../css/airClean.css" type="text/css"/>
	...
	<div class="product-head-info">
			<div class="product-head-box">
				...
				<div class="con">
					<a href="displayProductSummary.action?productName=米家空气净化器Pro">概述</a>&nbsp; |&nbsp;
					<a href="displayProductParameter.action?productName=米家空气净化器Pro">参数</a>&nbsp; |&nbsp;
					<a href="getCommentPage.action?productName=米家空气净化器Pro">用户评价</a>&nbsp; |&nbsp;
					<a href="selectProductInfo.action?productName=米家空气净化器Pro" class="btn-toBuy">立即购买</a>
				</div>
			</div>
		</div>
	...
	<div class="mi8-index">
			<div class="section section-index" style="height: 696px;">
				<div class="txt" style="z-index: 10px; margin-top:50px;">
					<h2 class="webfont">米家空气净化器</h2>
					<p class="webfont">专业级家用净化器     | 颗粒物CADR高达 1000m³/h</p>
					<div class="price">
						<span>
							<sup>¥</sup>
							<i>1999</i>
						...
						<div class="ui-viewport" style="width: 100%;position: relative;height: 697px;">
							<ul class="list clearfix" style="width: auto;position: relative; height:696px">
								<li class="slider clearfix" style="float: none;list-style: outside none none;width: 1263px;z-index: 50;display: block;opacity: 0.960116;height:696px">
									<img src="../images/airClean1.png" style="height:696px"/>
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="section section-infrared" id="box" style="height: 696px;">
				<h2 class="webfont" id="paragraph1" style="display: none;">专为大空间净化循环设计</h2>
				<p id="paragraph2" style="display: none;">全新双进风系统，洁净空气源源不断</p>
			</div>
		</div>
