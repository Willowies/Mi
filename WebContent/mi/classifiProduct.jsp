...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../css/classifiProduct.css" />
...
<div class="site-topbar">
	...
	<div class="site-header">
		...
		<div class="classification-page-main">
			<div class="classification-container channel-title">
				<h2>明星产品</h2>
			</div>
			<c:forEach items="${resultList}" var="p">
			<div class="classification-container channel-product-top">
