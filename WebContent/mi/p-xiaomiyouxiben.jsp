...
<html>
	<head>
		...
		<link href="../css/p-xiaomiyouxiben.css" rel="stylesheet">
...
<body>
	...
	<div class="product-head-info">
			<div class="product-head-box">
				<div class="product-name">小米游戏本</div>
				<div class="con">
	...
	<div class="parameter-container">
		...
		<div class="context">
			...
			<div class="sup">
				<dl class="left pt">
					<dd class="name">I7处理器</dd>
					<dd>性能怪兽</dd>
				</dl>
				<dl class="pt">
					<dd class="name">8GB+256GB </dd>
					<dd>超大内存，超大固态</dd>
				</dl>
				<dl class="left">
					<dd class="name">15.6寸  </dd>
					<dd>高保真 屏幕 </dd>
				</dl>
				<dl>
				...
				<dl class="left pb">
					<dd class="name">WIFI 5.0 </dd>
					<dd>杀手级网卡</dd>
				</dl>
				<dl class="pb">
					<dd class="name">2+1 HIFI </dd>
					<dd>最高可扩展256GB</dd>
				</dl>
			</div>
