    ...
    <div class="service-box service-main-box">
        <div class="service-content-box">
            ...
            <div class="box-bd">
                ...
                <div id="J_serviceChoosePro" class="service-step-box">
                    <div class="service-section">
                        <div class="section-hd is-noborder">
                            <h2 class="section-title">选择订单中的商品</h2>
                        </div>
                        <div class="section-bd">
                            <div class="xm-goods-list-wrap">
                            <c:forEach items="${tableList}"  var="tList">
                                <ul class="xm-goods-list service-goods-list clearfix">
                                        <li class="xm-goods-item">
                                            <div class="figure figure-img"><img src="../${tList.picUrl}" /></div>
                                            <h3 class="title">${tList.productName}&nbsp;&nbsp;&nbsp;${tList.version}</h3>
                                            <p class="imei"></p>
                                            <p class="rank"></p>
                                            <div class="actions">
                                                <a class="btn btn-small btn-primary " href="asChoosePro.action?asSn=${tList.asSn}">申请售后</a>
                                           </div>
                                        </li>
                               </ul>
                            </c:forEach>
