...
<body>
	...
	<div class="breadcrumbs">
		<div class="container">
			<a onclick="mainpage.jsp" href="//www.mi.com/index.html" data-stat-id="b0bcd814768c68cc">首页</a> 
			<span class="sep">></span> <span>申请售后服务</span>
		</div>
	</div>
	<!-- 导航栏部分  END -->
							...
							<div class="box-hd">
								<ul class="service-choose-list clearfix">
									...
									<li><i class="icon icon-fill"></i>
										<h3>填写申请单</h3>
										<p>
											其他渠道购买的商品 <br /> 根据产品唯一标识码和购物凭证申请售后
										</p> <a class="btn btn-line-green" href="AasChoosePro.jsp">申请售后</a></li>
								</ul>
							</div>
						</div>
					</div>
