				...
				<div class="productitem" id="pAll" style="display: none;">
					...
					<div class="productinfo">
						...
						<form id="stockForm" method="post">
							...
							<div>
								<input placeholder="增加库存量" name="stock" type="number" min="1" />
							</div>
							<input name="productId" value="" style="display: none;" />
							<div class="productinfoform">
								<button class="btn btn-default" type="button" onclick="setProductStock()">增加库存</button>
							</div>
						</form>
					</div>
				</div>
