            ...
            <div class="box-bd">
                <div class="service-progress">
                    <ol class="service-progress-list service-progress-list-col-3 clearfix">
                        ...
                        <li class="step step-last step-done">
                            <div class="progress"><span class="text">完成申请</span></div>
                        </li>
                    </ol>
                </div>

            <form action="finishApply.action" method="post">
                <div class="service-section">
                    <div class="section-bd">
                        <div class="result-detail">
                            <h2 class="title">申请成功！小米官方寄修服务</h2>
                                                        <p class="text">温馨提示：客服会在48小时内对您的申请进行审核，届时将通过短信将审核结果发送给您。建议您选择顺丰到付，如果是其他快递公司，请正常邮寄，后续判断您的受理符合快递报销准则，小米会为您报销快递费。</p>

                            <div class="actions">
                                <div class="btn-wrapper">
                                    <button class="btn btn-primary btn-small" type="submit">查看服务单详情</button>
                                                                    </div>
                            </div>
