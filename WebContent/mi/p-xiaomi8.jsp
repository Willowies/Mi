...
<html>
	<head>
		...
		<link href="../css/p-xiaomi8.css" rel="stylesheet">
...
<body>
	...
	<div class="product-head-info">
			<div class="product-head-box">
				<div class="product-name">小米8</div>
				<div class="con">
	...
	<div class="parameter-container">
		...
		<div class="context">
			...
			<div class="sub">
				<ul class="clearfix">
					<li class="icon icon1 "  onclick="changImg(1,4)" >
						<div></div>
						<p>蓝色</p>
					</li>
					
					<li class="icon icon2 " onclick="changImg(2,4)">
						<div></div>
						<p>金色</p>
					</li>
					<li class="icon icon3 " onclick="changImg(3,4)">
						<div ></div>
						<p>白色</p>
					</li>
					<li class="icon icon4 " onclick="changImg(4,4)">
						<div ></div>
						<p>黑色</p>
					</li>
				</ul>
