	...
	-->
		...
		<div class="personalcenter-main">
			...
			-->
				...
				-->
				<div class="main-page">
					<div class="recevierAddress-content">
						<div class="receiverAddress-hd">
							<h3 class="title">收货地址</h3>
						</div>
						
						<div class="receiverAddress-Item receiverAddress-new" onclick="showReceiverAddressHide()" >
							<i class="iconfont">+</i>
							添加新地址
						</div>
						
						<!-- <div class="receiverAddress-Item" >
							<dl>
								<dt>
									<em class="userName">周伟祥 </em>
									<span class="tag">家里</span>
								</dt>
								<dd>
									辽宁省 沈阳市 浑南区
									<br>
							...
							<div class="receiverAddress-actions">
								<a class="receiverAddress-modify">修改</a>
								<a class="receiverAddress-modify">删除</a>
							</div>
						</div> -->
						<c:forEach items="${resultList}"  var="r" >
							...
							<dl>
								<dt>
									...
									<span class="tag">${r.addressLabel}</span>
								</dt>
								<dd>
									${r.receiverPhone}
									<br>
									${r.receiverProvince}&#x0020;${r.receiverCity}&#x0020;${r.receiverDistrict}
									<br>
									${r.address}
								</dd>
							</dl>
							...
							<div class="receiverAddress-actions">
								<a class="receiverAddress-modify" onclick="updateReceiverAddress(${r.receiverAddressId})">修改</a>
								<a class="receiverAddress-modify" href="deleteReceiverAddress.action?receiverAddressId=${r.receiverAddressId}">删除</a>
							</div>
						</div>
						</c:forEach>
					</div>
				...
				<!--弹窗部分 -->
				<div class="receiverAddress-hide .receiveraddres-hide-edit windown-hide" id="receiverAddress-hide">
				<form action="addReceiverAddress.action" method="post" id ="addrecieverAddressForm">	
					<div class="receiveraddress-hide-add-header" >
						...
						<div class="wrapper-select-address windown-hide" id ="j_wrapperSelectAddress">
							<div class="wrapper-search-address">
								...
								<div class="search-address" >
									<ul class="list" id="j-search-address-result">
					...
					<div class="receiveraddress-hide-add-footer">
						<button class="btn btn-primary" type="submit">确定</button>
						<a class="btn btn-gray" id="close-receiverAddress-hide">取消</a>
					</div>
				</form>
				</div>
			</div>
