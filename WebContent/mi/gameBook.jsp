...
<html>
	...
	<div class="product-head-info">
			<div class="product-head-box">
				...
				<div class="con">
					<a href="displayProductSummary.action?productName=小米游戏本">概述</a>&nbsp; |&nbsp;
					<a href="displayProductParameter.action?productName=小米游戏本">参数</a>&nbsp; |&nbsp;
					<a href="getCommentPage.action?productName=小米游戏本">用户评价</a>&nbsp; |&nbsp;
					<a href="selectProductInfo.action?productName=小米游戏本" class="btn-toBuy">立即购买</a>
				</div>
			</div>
		</div>
	...
	<div class="mi8-index">
			<div class="section section-index" style="height: 696px;">
				<div class="txt" style="z-index: 10px; margin-top:50px;">
					<h2 class="webfont">小米游戏本</h2>
					<p class="webfont">电竞级性能怪兽</p>
					<div class="price">
						<span>
							<sup>¥</sup>
							<i>6599</i>
						...
						<div class="ui-viewport" style="width: 100%;position: relative;height: 697px;">
							<ul class="list clearfix" style="width: auto;position: relative; height:696px">
								<li class="slider clearfix" style="float: none;list-style: outside none none;width: 1263px;z-index: 50;display: block;opacity: 0.960116;height:696px">
									<img src="../images/gameBook1.png" style="height:696px"/>
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="section section-infrared" id="box" style="height: 696px;">
				<h2 class="webfont" id="paragraph1" style="display: none;">冷酷到底的散热系统</h2>
				<p id="paragraph2" style="display: none;">从进风区、热量传导系统到排放系统，我们全面突破，让小米游戏本整机散热效率提升 60%。</p>
			</div>
		</div>
