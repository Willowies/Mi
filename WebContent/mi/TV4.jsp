...
<html>
	<head>
		<link rel="stylesheet" href="../css/TV4.css" type="text/css"/>
	...
	<div class="product-head-info">
			<div class="product-head-box">
				...
				<div class="con">
					<a href="displayProductSummary.action?productName=小米电视4">概述</a>&nbsp; |&nbsp;
					<a href="displayProductParameter.action?productName=小米电视4">参数</a>&nbsp; |&nbsp;
					<a href="getCommentPage.action?productName=小米电视4">用户评价</a>&nbsp; |&nbsp;
					<a href="selectProductInfo.action?productName=小米电视4" class="btn-toBuy">立即购买</a>
				</div>
			</div>
		</div>
	...
	<div class="mi8-index">
			<div class="section section-index" style="height: 696px;">
				<div class="txt" style="z-index: 10px; margin-top:30px;">
					<h2 class="webfont">小米电视4&nbsp;&nbsp;75英寸</h2>
					<p class="webfont">超薄人工智能语音电视</p>
					<div class="price">
						<span>
							<sup>¥</sup>
							<i>8999</i>
						...
						<div class="ui-viewport" style="width: 100%;position: relative;height: 697px;">
							<ul class="list clearfix" style="width: auto;position: relative; height:696px">
								<li class="slider clearfix" style="float: none;list-style: outside none none;width: 1263px;z-index: 50;display: block;opacity: 0.960116;height:696px">
									<img src="../images/TV4.1.png" style="height:696px"/>
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="section section-infrared" id="box" style="height: 696px;">
				<h2 class="webfont" id="paragraph1" style="display: none;">大的刚刚好</h2>
				<p id="paragraph2" style="display: none;">超大尺寸，简约大气</p>
			</div>
		</div>
