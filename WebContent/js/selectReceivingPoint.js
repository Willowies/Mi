...
$(document).ready(function() {
 ...
 $(function() {
            if (localStorage.getItem('param_province')) {
                $("#param_province option").eq(localStorage.getItem('param_province')).prop('selected', true);
            }
 
            $("#param_province").on('change', function() {
                localStorage.setItem('param_province', $('option:selected', this).index());
            });
        });
